...
function setup()
{
    ...
    Block18=new Block(990,100,30,40);
    Block19=new Block(1020,100,30,40);
    //level 2 
    Block20=new Block(975,70,30,40);
    Block21=new Block(1005,70,30,40);
    // level 3
    Block22=new Block(990,40,30,40);
}
